...
namespace FuDong.Common
{
    ...
    public static class CollectionsExtensions
    {
        ...
        {
            Argument.NullParam(predicate, "predicate");
            return condition ? source.Where(predicate) : source;
        }
        ...
        {
            Argument.NullOrEmpty(propertyName, "propertyName");
        ...
        public static IQueryable<TEntity> Where<TEntity, TKey>(this IQueryable<TEntity> source, Expression<Func<TEntity, bool>> predicate, int pageIndex, int pageSize,
            out int total, PropertySortCondition[] sortConditions = null) where TEntity : EntityBase<TKey> //EntityBase<TKey>
        {
            Argument.NullParam(source, "source");
            Argument.NullParam(predicate, "predicate");
            Argument.NullParam(pageIndex, "pageIndex");
            Argument.NullParam(pageSize, "pageSize");
