...
namespace GanGao.Data.Configurations
{
    ...
    /// 权限表配置类
    /// </summary>
    public class PermissionConfiguration : EntityTypeConfiguration<PermissionEntity>, IEntityMapperDataBase
    {
    ...
    /// 权限部门表配置类
    /// </summary>
    public class PermissionDepartmentConfiguration : EntityTypeConfiguration<PermissionDepartmentRelation>, IEntityMapperDataBase
    {
        public PermissionDepartmentConfiguration()
        {
            ...
            //主键定义
            this.HasKey((PermissionDepartmentRelation m) => new { PermissionId = m.PermissionId, DepartmentId = m.DepartmentId });
            //索引定义
    ...
    /// 权限部门角色表配置类
    /// </summary>
    public class PermissionDepartmentRoleConfiguration : EntityTypeConfiguration<PermissionDepartmentRoleRelation>, IEntityMapperDataBase
    {
        public PermissionDepartmentRoleConfiguration()
        {
            ...
            //主键定义
            this.HasKey((PermissionDepartmentRoleRelation m) => new { PermissionId = m.PermissionId, DepartmentId = m.DepartmentId ,RoleId = m.RoleId});
            //索引定义
            this.HasIndex(m => m.PermissionId);
            this.HasIndex(m => m.DepartmentId);
            //属性定义
